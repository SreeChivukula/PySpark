...
conf = SparkConf().setMaster('local').setAppName('BasicRDD')
...
#     zipcode = int(zipcode)
#     if str(line['borough']) == "Brooklyn" and str(line['cuisine']) == "American ":
#         return line
    # if (zipcode > 11000):
    #     return line

# rdd1 = sc.textFile("restaurants.json")
...
#-----------------------------------------------------------------------------------------------
# rdd1 = sc.textFile("file:///Users/SreeC/PySpark/sample-data.csv")
# #
...
#-----------------------------------------------------------------------------------------------
rdd1 = sc.textFile("file:///Users/SreeC/PySpark/stream-data.csv")
...
# rdd1 = sc.textFile("/Users/SreeC/PySpark/sample-data.csv")
# rdd2 = sc.textFile("/Users/SreeC/PySpark/sample-data2.csv")
# rdd3 = sc.textFile("/Users/SreeC/PySpark/stream_data.csv")
#
...
# Use to sort the entire RDD based on ONE key. We can specify the key ourselves
#-----------------------------------------------------------------------------------------------
# rdd = sc.textFile("/Users/SreeC/PySpark/2015-12-12.csv")
# #
...
# rdd2 = rdd1.sortBy(lambda x: x.split(',')[2],ascending=True)
# #
...
# elements of the RDD.
#-----------------------------------------------------------------------------------------------
# rdd = sc.textFile("/Users/SreeC/PySpark/violations-data.csv")
#
...
#-----------------------------------------------------------------------------------------------z
# carRDD = sc.textFile("/Users/SreeC/PySpark/car_sales_data.csv")
#
